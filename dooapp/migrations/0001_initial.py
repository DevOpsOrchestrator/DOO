    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ManyToManyField(related_name='templates', to='dooapp.service')),
            ],
        ),
        migrations.CreateModel(
            name='provision',
            fields=[
                ...
                ('template', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='provision_template', to='dooapp.ticket')),
                ('ticket', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='provision_ticket', to='dooapp.ticket')),
