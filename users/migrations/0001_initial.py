    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('write_enabled', models.BooleanField(default=True, help_text='Permite criar/atualizar/deletar operações com essa chave')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actions', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=30), help_text='A lista de ações concedidas por esta permissão', size=None)),
                ('constraints', models.JSONField(blank=True, help_text='Filtro do conjunto de consultas que corresponde aos objetos aplicáveis do(s) tipo(s) selecionado(s)', null=True)),
