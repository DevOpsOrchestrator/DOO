...
urlpatterns = [
    ...
    path('playbook/file/add/<pk>',views.AddFileView.as_view(), name='playbook_file_add'),
    path('repo/<int:pk>/playbook/file/del/<file>',views.DeleteFileView.as_view(), name='playbook_file_del'),
